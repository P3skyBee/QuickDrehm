...
// pin 0
#define SERVO_FR 0 // rename to match what the servo does
// pin 1
#define SERVO_FL 1 // rename to match what the servo does
// pin 5
#define SERVO_BL 2 // rename to match what the servo does
// pin 6
#define SERVO_BR 3 // rename to match what the servo does
// pin 10
