...
//===============================================CREATE SETPOINTS FOR PID CONTROLLER===================================================//
  ...
  if (rc_channels[RC_TRANSITION] > 0.55) { // lets call aux1 angle mode for now, you can rename it later
...
//===============================================MODIFY SETPOINTS DURING FAILSAFE===================================================//
  ...
  if (failsafe) { // Set rc_channels/acro to values you want after failsafe
    ...
    rc_channels[RC_TRANSITION] = 1.0f; // set the aircraft to angle mode
